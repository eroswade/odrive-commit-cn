...
// round-robin fashion. ACD1 循环调度0-15的检测
// DMA is used to copy the measured 12-bit values to adc_measurements_. DMA, 拷贝检测数据到adc_measurements_
//
...
// brake resistor PWM accordingly. 回环电流
...
/* Analog speed control input 以下函数都是获取温度的 */
